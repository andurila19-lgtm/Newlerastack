...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-slate-950 border-t border-slate-900 py-12 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Links: Products */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">{dict.footer.links1}</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/#templates" className="text-sm text-slate-400 hover:text-emerald-400 transition-colors">
                  {dict.footer.l1_1}
                </Link>
              </li>
              <li>
          ...
          {/* Links: Support */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">{dict.footer.links2}</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Links: Legal */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">{dict.footer.links3}</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-sm text-slate-400 hover:text-emerald-400 transition-colors">
                  {dict.footer.l3_1}
        ...
        <div className="mt-12 border-t border-slate-900 pt-6 flex flex-col md:flex-row items-center justify-between">
